class AbstractChosen
  ...
  set_default_values: ->
    ...
    @allow_single_deselect = if @options.allow_single_deselect? and @form_field.options[0]? and (@form_field.options[0].text is "" or @options.disable_tags) then @options.allow_single_deselect else false
